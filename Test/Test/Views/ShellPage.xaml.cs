...
namespace Test.Views
{
    ...
    public sealed partial class ShellPage : Page, INotifyPropertyChanged
    {
        ...
        private void ShellMenuItemClick_Views_Blank(object sender, RoutedEventArgs e)
        {
            MenuNavigationHelper.UpdateView(typeof(BlankPage));
        }
        ...
        private void ShellMenuItemClick_Views_InkSmartCanvas(object sender, RoutedEventArgs e)
        {
            MenuNavigationHelper.UpdateView(typeof(InkSmartCanvasPage));
        }
